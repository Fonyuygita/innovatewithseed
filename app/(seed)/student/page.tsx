...
const StudentPage = () => {
    ...
    return (
        <div className={`w-full min-h-screen pt-[8rem] ${theme === "light" ? "bg-light-200 text-gray-800" : "bg-gray-800 text-light-200"}`}>
            <div className={`flex-center relative min-h-[384px] w-[90%] mx-auto flex-col rounded-xl  bg-cover bg-center  text-center ${theme === 'light' ? "bg-blog" : "bg-ban"}`}>
                <h1 className="lg:flex hidden sm:heading1 heading2  mb-6 text-center text-white ">
