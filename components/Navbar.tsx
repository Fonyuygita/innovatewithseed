        ...
        <div className='bg-[#fff] w-[100%] mr-auto ml-auto px-[5%] h-[110px] fixed top-0 left-0 z-30'>
            <nav className='flex justify-between items-center p-2 h-full'>
                ...
                <div className="flex items-center justify-center gap-x-10">
                    ...
                    <button className='text-lg py-2  items-center justify-center outline-none   bg-[radial-gradient(ellipse_at_top,_var(--tw-gradient-stops))] from-blue-950 to-blue-900 text-white md:flex hidden rounded-3xl px-8  hover:scale-110  transition p-3'>Courses</button>
                </div>
