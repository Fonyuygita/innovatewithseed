...
const AboutUsTop = () => {
    ...
    return (
        <section className={`p-8 mt-[5rem] bg-gray-100 w-full h-full flex items-center justify-center overflow-hidden  ${theme === 'light' ? 'bg-gray-200 ' : 'bg-gray-800 text-white  '}`}>
            <div className="container mx-auto text-primary-100">
                ...
                <p className={`w-[70%] lg:w-[40%] text-gray-600 text-sm ${theme === "light" ? "text-gray-700" : "text-gray-300"}`}>
                ...
                <motion.p
                    ...
                    className={`text-[14px] md:text-lg mb-8 text-gray-700 w-full my-3 ${theme === "light" ? "text=gray-700" : "text-gray-300"}`}
                >
