...
const Internship = () => {
    return (
        <section className='w-full px-6 mt-[32rem] flex items-center justify-center h-[100vh] gap-[3rem] '>
            <div className="flex flex-col items-center justify-center w-full">
                <div className="flex flex-col w-[60%] ml-[5%]  bg-slate-300 gap-4 rounded-lg py-5">
